...
public class HotelGetterAndSetterTest {
    private Room room1;
    private Room room2;
    private Room room3;
    private Room room4;
    ...
    void getMonthlyBookings() {
        ...
        reservationSystem.bookRoomInHotel(room1, LocalDate.of(2021, 1, 5), LocalDate.of(2021, 1, 8), hotel1, client1);
        reservationSystem.bookRoomInHotel(room2, LocalDate.of(2021, 1, 22), LocalDate.of(2021, 4, 24), hotel1, client2);

        reservationSystem.bookRoomInHotel(room1, LocalDate.of(2022, 4, 1), LocalDate.of(2022, 4, 3), hotel1, client1);
        reservationSystem.bookRoomInHotel(room2, LocalDate.of(2022, 4, 12), LocalDate.of(2022, 4, 17), hotel1, client2);
        reservationSystem.bookRoomInHotel(room1, LocalDate.of(2022, 4, 12), LocalDate.of(2022, 4, 17), hotel1, client1);

        reservationSystem.bookRoomInHotel(room2, LocalDate.of(2023, 12, 12), LocalDate.of(2023, 4, 17), hotel1, client2);
        reservationSystem.bookRoomInHotel(room1, LocalDate.of(2023, 12, 12), LocalDate.of(2023, 4, 17), hotel1, client1);
        reservationSystem.bookRoomInHotel(room2, LocalDate.of(2023, 12, 1), LocalDate.of(2023, 4, 3), hotel1, client2);

        Map<Month, Integer> expected = new HashMap<>();
        expected.put(Month.JANUARY, 2);
        expected.put(Month.APRIL, 3);
        expected.put(Month.DECEMBER, 3);

        // what to expect?
        assertEquals(expected, hotel1.getMonthlyBookings());
    }
