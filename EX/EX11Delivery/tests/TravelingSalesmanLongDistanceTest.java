...
class TravelingSalesmanLongDistanceTest {
    ...
    void test() {
        ...
        TravelingSalesmanLongDistance strategy = new TravelingSalesmanLongDistance();
        ...
        assertEquals(0, parnu.getPackets().size());
        assertEquals(0,narva.getPackets().size());
        assertFalse(courier1.getLocation().isPresent()); // moving to tartu (5 steps)
        assertEquals(List.of(packetTallinn5, packetTallinn6, packetTallinn3, packetTallinn4, packetTallinn1, packetTallinn2), courier1.getPacketList());
        ...
        assertEquals(0, parnu.getPackets().size());
        assertEquals(0,narva.getPackets().size());
        assertFalse(courier1.getLocation().isPresent()); // moving to tartu (4 steps)
        assertEquals(List.of(packetTallinn5, packetTallinn6, packetTallinn3, packetTallinn4, packetTallinn1, packetTallinn2), courier1.getPacketList());
        ...
        assertEquals(0, parnu.getPackets().size());
        assertEquals(0,narva.getPackets().size());
        assertFalse(courier1.getLocation().isPresent()); // moving to tartu (3 steps)
        assertEquals(List.of(packetTallinn5, packetTallinn6, packetTallinn3, packetTallinn4, packetTallinn1, packetTallinn2), courier1.getPacketList());
        ...
        assertEquals(0, parnu.getPackets().size());
        assertEquals(0,narva.getPackets().size());
        assertFalse(courier1.getLocation().isPresent()); // moving to narva (2 steps)
        assertEquals(List.of(packetTallinn5, packetTallinn6, packetTallinn3), courier1.getPacketList());
        ...
        assertFalse(courier1.getLocation().isPresent()); // moving to parnu (5 steps)
        ...
        assertEquals(0, parnu.getPackets().size());
        assertEquals(2,narva.getPackets().size());
        assertFalse(courier1.getLocation().isPresent()); // moving to parnu (4 steps)
        assertEquals(List.of(packetTallinn3), courier1.getPacketList());
        ...
        assertEquals(0, parnu.getPackets().size());
        assertEquals(2,narva.getPackets().size());
        assertFalse(courier1.getLocation().isPresent()); // moving to parnu (3 steps)
        assertEquals(List.of(packetTallinn3), courier1.getPacketList());
        ...
        assertEquals(1, parnu.getPackets().size());
        assertEquals(2,narva.getPackets().size());
        assertEquals(tallinn, courier1.getLocation().get()); // stays at tallinn and wait for packages
        assertEquals(List.of(), courier1.getPacketList());
    }
}
